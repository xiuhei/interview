---
id: q_cpp_backend_comparison_223
doc_type: question
role: cpp_backend
category: comparison
...
difficulty: medium
tags: [cpp_backend, comparison, lambda_capture, language, cpp_language, cpp, lambda]
source_priority: high
applicable_features: [interview, scoring, practice, follow_up]
---
# Lambda 捕获 和 vector 扩容 应该怎么比较？

## question
请对比 Lambda 捕获 和 vector 扩容 的适用场景、优缺点以及你在项目里会如何选择。
