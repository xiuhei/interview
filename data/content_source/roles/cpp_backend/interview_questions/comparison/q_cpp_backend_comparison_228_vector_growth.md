---
id: q_cpp_backend_comparison_228
doc_type: question
role: cpp_backend
category: comparison
...
difficulty: medium
tags: [cpp_backend, comparison, vector_growth, stl_template, cpp_language, cpp, vector]
source_priority: high
applicable_features: [interview, scoring, practice, follow_up]
---
# vector 扩容 和 二分边界 应该怎么比较？

## question
请对比 vector 扩容 和 二分边界 的适用场景、优缺点以及你在项目里会如何选择。
