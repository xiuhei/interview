---
id: q_cpp_backend_comparison_236
doc_type: question
role: cpp_backend
category: comparison
...
difficulty: hard
tags: [cpp_backend, comparison, atomic_order, concurrency, os_network, cpp, atomic]
source_priority: high
applicable_features: [interview, scoring, practice, follow_up]
---
# 原子操作与内存序 和 epoll 应该怎么比较？

## question
请对比 原子操作与内存序 和 epoll 的适用场景、优缺点以及你在项目里会如何选择。
