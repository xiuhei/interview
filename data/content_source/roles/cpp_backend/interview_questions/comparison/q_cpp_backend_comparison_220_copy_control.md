---
id: q_cpp_backend_comparison_220
doc_type: question
role: cpp_backend
category: comparison
...
difficulty: medium
tags: [cpp_backend, comparison, copy_control, language, cpp_language, cpp, copy_control]
source_priority: high
applicable_features: [interview, scoring, practice, follow_up]
---
# 拷贝控制 和 weak_ptr 应该怎么比较？

## question
请对比 拷贝控制 和 weak_ptr 的适用场景、优缺点以及你在项目里会如何选择。
