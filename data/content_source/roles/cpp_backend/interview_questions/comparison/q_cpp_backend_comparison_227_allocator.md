---
id: q_cpp_backend_comparison_227
doc_type: question
role: cpp_backend
category: comparison
...
difficulty: hard
tags: [cpp_backend, comparison, allocator, stl_template, cpp_language, cpp, allocator]
source_priority: high
applicable_features: [interview, scoring, practice, follow_up]
---
# STL 分配器 和 Concepts 应该怎么比较？

## question
请对比 STL 分配器 和 Concepts 的适用场景、优缺点以及你在项目里会如何选择。
