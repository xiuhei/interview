---
id: q_web_frontend_comparison_243
doc_type: question
role: web_frontend
category: comparison
...
difficulty: hard
tags: [web_frontend, comparison, reflow_repaint, browser_rendering, browser_principle, web, render]
source_priority: high
applicable_features: [interview, scoring, practice, follow_up]
---
# 回流与重绘 和 同源策略与 CORS 应该怎么比较？

## question
请对比 回流与重绘 和 同源策略与 CORS 的适用场景、优缺点以及你在项目里会如何选择。
